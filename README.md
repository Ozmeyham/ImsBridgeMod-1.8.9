...
Download the latest .jar file from [releases](https://github.com/Ozmeyham/ImsBridgeMod-1.8.9/releases)
and place it in your mods folder. This is the Forge version for Minecraft 1.8.9 and requires
both Forge and Java to be installed. 

For the latest Fabric release (1.21 and up) see [this repo](https://github.com/Ozmeyham/ImsBridgeMod-1.21.5).
